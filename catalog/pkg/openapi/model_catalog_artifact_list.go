...
func (o *CatalogArtifactList) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogArtifactList := _CatalogArtifactList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogArtifactList)

	if err != nil {
		return err
	}

	*o = CatalogArtifactList(varCatalogArtifactList)
